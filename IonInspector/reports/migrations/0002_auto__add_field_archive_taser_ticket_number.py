...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Archive.taser_ticket_number'
        db.add_column(u'reports_archive', 'taser_ticket_number',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Archive.taser_ticket_number'
        db.delete_column(u'reports_archive', 'taser_ticket_number')
