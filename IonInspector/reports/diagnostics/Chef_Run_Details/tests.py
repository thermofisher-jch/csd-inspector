...
from reports.diagnostics.Chef_Run_Details.main import (
    get_deviation_from_element_tree,
...
class ChefRunDetailsTestCase(SimpleTestCase):
    ...
    test_xml_path_3 = (
        "/var/lib/media/archive_files/105360/var/log/IonChef/RunLog/Clinical_CHEF1"
    ...
    def test_get_deviation_with_lib_from_element_tree(self):
        ...
        self.assertEquals(
            get_deviation_from_element_tree(element_tree), "Myeloid (200bp)"
        )
    ...
    def test_get_deviation_with_lib_not_int_from_element_tree(self):
        ...
        self.assertEquals(
            get_deviation_from_element_tree(element_tree), "Myeloid (ERROR)"
        )
    ...
    def test_get_unknown_deviation_from_element_tree(self):
        ...
        self.assertEquals(
            get_deviation_from_element_tree(element_tree), "Unknown(some_new_thing)"
        )
