...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'reports_archive', 'doc_file', self.gf('django.db.models.fields.files.FileField')(max_length=1000, null=True))

    def backwards(self, orm):

        # Changing field 'Archive.doc_file'
        db.alter_column(u'reports_archive', 'doc_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
