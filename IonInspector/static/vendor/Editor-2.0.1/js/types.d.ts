...
declare class Field {
	...
	update(options: any, append?: boolean): void;
	val(val?: any): any;
...
declare function ajax(this: Editor, newAjax: any): string | Function | Editor | import("../model/settings").IAjaxOptions;
...
declare function field(this: Editor, name: any): import("../field/Field").default;
...
declare function node(this: Editor, name: any): JQuery.TypeOrArray<HTMLElement>;
