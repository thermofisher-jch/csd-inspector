...
urlpatterns = patterns(
    ...
    url(r'^site_media/resources/kendo/styles/kendo.common.min.css$', RedirectView.as_view(url='/static/css/kendo.common.min.css', permanent=True)),
    url(r'^site_media/resources/less/kendo.tb.min.css$', RedirectView.as_view(url='/static/css/kendo.tb.css', permanent=True)),
    url(r'^site_media/resources/styles/tb-layout.css$', RedirectView.as_view(url='/static/css/tb-layout.min.css', permanent=True)),
    url(r'^site_media/resources/styles/tb-styles.min.css$', RedirectView.as_view(url='/static/css/tb-styles.min.css', permanent=True)),
    url(r'^site_media/stylesheet.css$', RedirectView.as_view(url='/static/css/stylesheet.css', permanent=True)),
    url(r'^site_media/resources/styles/print.css$', RedirectView.as_view(url='/static/css/print.css', permanent=True)),
