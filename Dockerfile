...
RUN apt-get update && apt-get install -y python-numpy python-pip celeryd python-dev r-base r-cran-rjson python-matplotlib libpq-dev python-lxml python-bs4 python-lzma
